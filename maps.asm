...
INCLUDE "data/maps/headers/OakFightRoom.asm"
INCLUDE "scripts/OakFightRoom.asm"
INCLUDE "data/maps/objects/OakFightRoom.asm"
OakFightRoom_Blocks: INCBIN "maps/OakFightRoom.blk"
