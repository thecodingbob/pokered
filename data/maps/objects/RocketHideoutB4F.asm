RocketHideoutB4F_Object:
	...
	def_object_events
	object_event 25,  9, SPRITE_GIOVANNI, STAY, DOWN, 1, OPP_GIOVANNI, 1
	...
	object_event 28,  7, SPRITE_POKE_BALL, STAY, NONE, 7, TM_ROCK_SLIDE
	object_event 25,  8, SPRITE_POKE_BALL, STAY, NONE, 8, RARE_CANDY
