SaffronCity_Object:
	...
	warp_event 18, 21, SILPH_CO_7F, 5
	warp_event  9, 29, SAFFRON_POKECENTER, 1
	warp_event 29, 29, ROUTE_15_GATE_1F, 3
	...
	object_event 15,  7, SPRITE_ROCKET, WALK, LEFT_RIGHT, 2 ; person
	object_event 35,  4, SPRITE_ROCKET, STAY, NONE, 3 ; person
	...
	object_event 10,  6, SPRITE_SCIENTIST, WALK, ANY_DIR, 8 ; person
	...
	object_event 20, 22, SPRITE_ROCKET, STAY, DOWN, 15 ; person
