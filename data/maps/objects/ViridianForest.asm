ViridianForest_Object:
	...
	def_warp_events
	warp_event  1,  0, ROUTE_2, 2
	warp_event  2,  0, ROUTE_2, 2
	...
	def_object_events
	object_event 15, 43, SPRITE_YOUNGSTER, STAY, NONE, 1 ; person
	...
	object_event  4, 25, SPRITE_POKE_BALL, STAY, NONE, 5, RARE_CANDY
	object_event 17, 41, SPRITE_POKE_BALL, STAY, NONE, 6, RARE_CANDY
	object_event 16, 41, SPRITE_POKE_BALL, STAY, NONE, 7, RARE_CANDY
